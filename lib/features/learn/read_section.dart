...
class _ReadSectionState extends State<ReadSection>
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Text('Retry', style: TextStyle(color: AppColors.accent, fontSize: 13, fontWeight: FontWeight.w600)),
              ),
            ),
          ],
        ),
    ...
    if (_posts.isEmpty) {
      return const Center(
          child: Text('No articles yet', style: TextStyle(color: AppColors.muted)));
    }
              ...
              child: Column(
                ...
                children: [
                  if (post.labels.isNotEmpty)
                    Wrap(
                      spacing: 5,
                      children: post.labels.take(3).map((l) => Container(
                        ...
                        child: Text(l, style: const TextStyle(fontSize: 9, color: AppColors.blue, fontWeight: FontWeight.w600)),
                      )).toList(),
                    ),
                  ...
                  Text(post.summary,
                      ...
                      style: const TextStyle(fontSize: 12, height: 1.6, color: Color(0xFF8A9DC0))),
                      ...
                      Container(
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 4),
                            Icon(Icons.open_in_new, size: 12, color: AppColors.blue),
                          ],
                        ),
                      ),
                    ],
